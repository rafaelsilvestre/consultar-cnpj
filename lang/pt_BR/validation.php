...
return [
    ...
    'cpf'                 => 'O campo :attribute deve ser válido.',
    'cnpj'                 => 'O campo :attribute deve ser válido.',
    'attributes'           => [
        'address'                  => 'endereço',
        'age'                      => 'idade',
        'amount'                   => 'Motante',
        ...
        'insured_cpf' => 'cpf',
        'insured_cnpj' => 'cnpj',
        'customer_request_description' => 'solicitação do cliente',
        'customer_orientation' => 'orientação dada ao cliente',
        'internal_notes' => 'anotações internas',
        'paid_in_advance' => 'pago antecipado',
        'negotiated_value' => 'valor negociado',
        'origin_address_additional' => 'complemento da origem',
        'destination_address_additional' => 'complemento do destino',
        'origin_address_zip_code' => 'cep da origem',
        'destination_address_zip_code' => 'cep do destino',
        'forecast_for' => 'previsão para',
        'filter_by' => 'filtro',
        'reason_for_cancellation' => 'motivo do cancelamento',
        'cancelled_by' => 'quem solicitou o cancelamento',
        'car_plate' => 'placa',
        'car_chassi' => 'chassi',
        'arrival_forecast' => 'previsão de chegada',
        'observation' => 'observação',
        'assistance_service_id' => 'serviço',
    ],
    'custom' => [
        'attribute-name' => [
